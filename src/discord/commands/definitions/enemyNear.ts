...
export const enemyNearCommand = new SlashCommandBuilder()
  .setName('enemy-near')
  .setDescription('Find enemy villages near a coordinate (uses diplomacy settings)')
...
registerCommand(enemyNearCommand);
